...
import (
	...
	dbm "github.com/rayhero/gqlgen-todos/src/base/gorm/models"
	"github.com/rayhero/gqlgen-todos/src/base/gqlgen/models"
	tf "github.com/rayhero/gqlgen-todos/src/base/gqlgen/resolvers/transformations"
)
...
func userList(r *queryResolver, id *string) (*models.Users, error) {
	...
	for _, dbRec := range dbRecords {
		if rec, err := tf.DBUserToGQLUser(dbRec); err != nil {
			// logger
			fmt.Println(fmt.Errorf(entity, err))
		} else {
